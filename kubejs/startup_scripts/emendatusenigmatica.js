...
const emendatusenigmatica_metal_type = [
    'clump',
    'crystal',
    'dirty_dust',
    'dust',
...
const emendatusenigmatica_alloy_type = [
    'dust',
    'gear',
    'ingot',
    'nugget',
...
const emendatusenigmatica_gem_type = [
    'clump',
    '_cluster_shard',
    'crystal',
    'dirty_dust',
...
const emendatusenigmatica_vanilla_type = [
    'clump',
    'crystal',
    'dirty_dust',
    'dust',
...
onEvent('item.registry', event => {
    ...
    emendatusenigmatica_vanilla.forEach((item) => {
        ...
        if (item != 'netherite' && item != 'redstone') {
        ...
        if (item != 'coal' && item != 'lapis' && item != 'redstone' && item != 'quartz' && item != 'copper' && item != 'diamond' && item != 'emerald' && item != 'gold' && item != 'iron' && item != 'netherite') {
        ...
        if (item != 'copper' && item != 'gold' && item != 'iron' && item != 'netherite' && item != 'gold') {
        ...
        if (item != 'copper' && item != 'coal' && item != 'iron' && item != 'quartz' && item != 'diamond' && item != 'emerald' && item != 'gold' && item != 'netherite' && item != 'redstone' && item != 'lapis') {
